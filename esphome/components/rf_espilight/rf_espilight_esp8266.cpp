...
static const char *TAG = "rf_espilight.esp8266";

void ICACHE_RAM_ATTR HOT RFESPiLightComponentStore::gpio_intr(RFESPiLightComponentStore *arg) {
...
void RFESPiLightComponent::setup() {
  ...
  this->pin_->attach_interrupt(RFESPiLightComponentStore::gpio_intr, &this->store_, CHANGE);
}
void RFESPiLightComponent::dump_config() {
...
void RFESPiLightComponent::loop() {
  auto &s = this->store_;
